...
**
** Description:
** Standart version bug: QBluetoothlocaldevice couldn't pair with
** devices by user input pin and with devices using 4-digit pin like
** 0000 or 1234
**
** This version solve this problem. To use it, requires recompiling
** QtAndroidBluetooth.jar in jar directory for needed Qt android release
** version. For more information visit https://github.com/e-protocol
**
****************************************************************************/
    ...
    public void onReceive(Context context, Intent intent)
        {
            synchronized (qtContext)
            {
                if (qtObject == 0)
                    ...
                    if(intent.getAction().equals("android.bluetooth.device.action.PAIRING_REQUEST") && state != BluetoothDevice.BOND_NONE)
                    {
